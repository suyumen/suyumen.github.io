...
function(e, t, o) {
    ...
    t.
default = function() { (!sessionStorage.getItem("profile") || sessionStorage.getItem("profile") && "true" === sessionStorage.getItem("profile")) && $("#cxo-profile").removeClass("profile-close"),
        0 !== $(document).scrollTop() && $("#go-up").removeClass("chose"),
        $(".profile-avatar>i").on("click",
        function(e) {
            ...
            function(e) {
                if (d) {
                    ...
                    if (t && o.attr("href") !== t) {
                        ...
                        r.addClass("active"),
                        r.parents(".toc-child").siblings(".toc-link").addClass("active")
                    }
                }
            } (u))
        }
